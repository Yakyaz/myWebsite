...
const Spotify = async () => {
  ...
  return (
    <div className=" md:pl-10 md:flex-none md:justify-start md:items-start flex justify-center items-center">
      <div className=" justify-center  flex flex-row items-center mt-2  bg-gray-300  md:w-60 md:h-20 p-2 bg-opacity-20  shadow-xl border rounded-3xl border-gray-600">
        <img
