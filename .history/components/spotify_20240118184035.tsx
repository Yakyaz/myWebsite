...
const Spotify = async () => {
  ...
  return (
    <div className=" md:ml-10 ">
      <div className="justify justify-center items-center flex flex-row items-center mt-2  bg-gray-300 w-60 p-2 bg-opacity-20  shadow-xl border rounded-3xl border-gray-600">
        <img
