...
function Home() {
  return (
    <main className="w-screen h-screen flex flex-col items-center justify-center ">
      <div
        className="w-11/12 flex justify-center items-center mockup-window border bg-base-300 "
        style={{
          height: "90%",
        }}
      >
        <div className="flex flex-col justify-center items-center ">
          <div className="border rounded-full mb-3 h-36 w-36 text-center avatar online">
            <Image
      ...
      <div className="w-screen h-52 mb-8">
        <Spotify />
      </div>
    </main>
  );
